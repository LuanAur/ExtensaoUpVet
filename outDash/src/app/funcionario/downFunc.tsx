...
const ListFunc: React.FC = () => {
  ...
  useEffect(() => {
    ...
    const fetchFuncionarios = async () => {
      setLoading(true);
      try {
        const response = await authFetch("https://admin.spai.org.br/api/funcionario");
  ...
  const onRowEditComplete = async (e: DataTableRowEditCompleteEvent) => {
    ...
    try {
      const response = await authFetch(`https://admin.spai.org.br/api/funcionario/${updatedFuncionario.id}`, {
        method: "PUT",
  ...
  const deleteFuncionario = async (id: number) => {
    try {
      const response = await authFetch(`https://admin.spai.org.br/api/funcionario/${id}`, { method: "DELETE" });
