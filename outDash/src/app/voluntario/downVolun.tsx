...
const ListVolun: React.FC = () => {
  ...
  const onRowEditComplete = async (e: DataTableRowEditCompleteEvent) => {
    ...
    try {
      const response = await authFetch(`https://admin.spai.org.br/voluntarios/${updatedVoluntario.id}`, {
        method: "PUT",
  ...
  const deleteVoluntario = async (id: number) => {
    try {
      const response = await authFetch(`https://admin.spai.org.br/voluntarios/${id}`, { method: "DELETE" });
