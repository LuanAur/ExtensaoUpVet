...
const ListFluxoCaixa: React.FC = () => {
  ...
  const fetchLancamentos = async () => {
    setLoading(true);
    try {
      const res = await authFetch("https://admin.spai.org.br/api/valor");
  ...
  const onRowEditComplete = async (e: DataTableRowEditCompleteEvent) => {
    ...
    try {
      const response = await authFetch(`https://admin.spai.org.br/api/valor/${updatedLancamento.id}`, {
        method: "PUT",
  ...
  const deleteLancamento = async (id: number) => {
    try {
     const response =  await authFetch(`https://admin.spai.org.br/api/valor/${id}`, {
        method: "DELETE",
      });
